...
export const metadata: Metadata = {
  title: 'AI Ad Background Anime Generator - Create Stunning Anime Ads | GenAnime',
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://genanime.art/ai-ad-background-anime',
    images: [
      {
        url: 'https://genanime.art/gallery/cyberpunk-street.webp',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'AI Ad Background Anime Generator | GenAnime',
