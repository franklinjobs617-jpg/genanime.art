...
export default function GalleryCard({ src, prompt, style, ratio, onSelect, index }: GalleryCardProps) {
    return (
        <motion.div
            ...
            onClick={onSelect}
            className="break-inside-avoid mb-6 group relative cursor-pointer rounded-2xl overflow-hidden bg-zinc-900 shadow-xl border border-white/5 transition-all duration-300"
        >
