...
export default function RedesignedSidebar({
  ...
  const models = [
    {
      value: "Pony-Diffusion-V6",
      label: "Pony Diffusion V6",
      desc: "The #1 model for anime logic & complex prompts",
    },
    {
      value: "Animagine-XL-3.1",
      label: "Animagine XL 3.1",
      desc: "High fidelity character reproduction",
    },
    {
      value: "Niji-Journey-V6",
      label: "Niji Journey V6",
      desc: "Artistic & expressive anime aesthetics",
    },

    {
      value: "Flux.1-Dev",
      label: "Flux.1 Dev",
      desc: "State-of-the-art detail & text rendering",
    },
    {
      value: "Flux.1-Schnell",
      label: "Flux.1 Schnell",
      desc: "Turbo speed model for quick concepts",
    },

    {
      value: "Counterfeit-V3.0",
      label: "Counterfeit V3.0",
      desc: "Masterpiece quality 2D illustration style",
    },
    {
      value: "Anything-V5",
      label: "Anything V5",
      desc: "General purpose high-quality anime art",
    },
    {
      value: "DreamShaper-XL",
      label: "DreamShaper XL",
      desc: "Perfect balance between realism and anime",
    },

    {
      value: "Sora",
      label: "Sora Video/Image",
      desc: "Advanced video and consistency generation",
    },
    {
      value: "Stable-Diffusion-3",
      label: "Stable Diffusion 3",
      desc: "Latest generation architecture",
    },
    {
      value: "Midjourney-V6",
      label: "Midjourney V6 Clone",
      desc: "Cinematic lighting and composition",
    },
  ];
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 p-1 bg-white/[0.02] border border-white/5 rounded-xl">
            <button
              ...
              className={`flex items-center justify-center gap-2 py-2 text-[11px] font-bold rounded-lg transition-all ${
                ...
                >
                  {models.map((model) => (
                    <button
                      ...
                      className={`w-full px-4 py-3 text-left transition-all duration-200 flex flex-col gap-0.5 ${
              ...
              {styles.map((style) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative aspect-[1.3] w-full overflow-hidden rounded-xl border transition-all duration-300 ${
                      isActive
                  ...
                  >
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-2 text-center z-10">
                      <span
                        className={`text-[10px] font-bold tracking-wide shadow-black/50 drop-shadow-md ${
                          isActive
                            ? "text-white"
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              {ratios.map((r) => (
                ...
                >
                  <div
                    className={`border rounded-[2px] mb-1.5 transition-all ${
                      activeRatio === r.label
                ...
                <div className="pt-4 pb-2 space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-xs">
                      ...
                      <span className="bg-white/5 px-2 py-0.5 rounded text-zinc-300 tabular-nums">
                        {cfgScale}
                      </span>
                    </div>
                    <input
