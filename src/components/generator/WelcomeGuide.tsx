    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed top-4 left-1/2 transform -translate-x-1/2 w-[calc(100vw-24px)] max-w-[calc(100vw-24px)] sm:max-w-md z-[9999] pointer-events-auto"
          style={{ left: "50%", transform: "translateX(-50%)" }}
        >
          <div className="bg-zinc-900/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-3 sm:p-4 flex items-start gap-3 max-w-full">
            ...
            <div className="flex-1 min-w-0 max-w-[calc(100%-48px)]">
              ...
              <p className="text-xs text-zinc-400 mt-1 sm:mt-1.5 truncate">
                You have 2 free generations to try. Describe what you want to
                create and click Generate!
              </p>
            </div>
          </div>
        </motion.div>
