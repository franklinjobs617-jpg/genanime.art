  ...
  return (
    <section className="relative w-full min-h-screen bg-[#030305] font-sans selection:bg-indigo-500/30 flex flex-col">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#030305]/70 via-[#030305]/35 to-transparent z-[1]" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#030305]/55 via-transparent to-transparent z-[1]" />
      </div>
        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <motion.form
              ...
              className="flex items-center gap-3 bg-white/5 backdrop-blur-2xl px-4 sm:px-6 py-3 rounded-2xl w-full max-w-xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] group focus-within:border-indigo-500/50 transition-all"
            >
            ...
            <div className="flex flex-wrap gap-3 md:gap-6 text-[10px] sm:text-xs md:text-sm font-bold text-zinc-500 uppercase tracking-widest pt-1">
